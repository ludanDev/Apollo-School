...
function initializeIndexPage() {
  ...
  // Add click event listener to all sections to hide navbar when clicked
  document.querySelectorAll('section, .nav-link').forEach(element => {
...
async function submitForm() {
  ...
  try {
    ...
    const whatsappNumber = '+249902055875';
